...
2. **Architect Phase (Saboteur You):**
   ...
   - Must be fair: obstacles must be avoidable by _some means_.

3. **Repeat:**

   - Your previous attempts become _ghosts_ (or enemies).
...
- Make it about _efficiency vs sabotage_.
- You want to _just barely_ stop yourself — overdoing it ruins the fun.
